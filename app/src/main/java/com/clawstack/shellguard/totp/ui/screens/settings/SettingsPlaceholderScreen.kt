...
fun SettingsPlaceholderScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                "This section arrives in an upcoming phase: automatic backups in Phase 13 (v0.0.3.0), Icon Packs in Phase 14 (v0.1.0.0). Security, Audit Log, Server connection, sync, theme, and import/export settings are available now under their own categories.",
                fontSize = 13.sp,
